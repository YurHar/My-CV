...
const appCss = "/assets/app-DueUZzQJ.css";
const seo = ({
  title,
  description,
  keywords,
...
function Header() {
  ...
  return /* @__PURE__ */ jsxs("header", { className: "sticky top-0 z-50 bg-slate-800/80 backdrop-blur border-b border-slate-700", children: [
    /* @__PURE__ */ jsxs("nav", { className: "max-w-6xl mx-auto flex items-center justify-between px-4 sm:px-6 py-3", children: [
      /* @__PURE__ */ jsx(Link, { to: "/", className: "flex items-center gap-2 text-xl font-bold tracking-wide text-white hover:text-blue-400 transition", children: /* @__PURE__ */ jsx("img", { src: "/logo.svg", alt: "Yuri.dev", className: "w-[170px] h-10" }) }),
      ...
      /* @__PURE__ */ jsx("button", { onClick: () => setIsOpen(!isOpen), "aria-label": "Toggle navigation menu", className: "md:hidden p-2 rounded hover:bg-slate-700/60 focus:outline-none focus:ring-2 focus:ring-blue-500 text-white", children: isOpen ? /* @__PURE__ */ jsx(X, { className: "w-6 h-6" }) : /* @__PURE__ */ jsx(Menu, { className: "w-6 h-6" }) })
    ] }),
    isOpen && /* @__PURE__ */ jsx("div", { className: "md:hidden border-t border-slate-700 bg-slate-900/95 backdrop-blur-lg", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center space-y-4 px-6 py-5 text-white text-base", children: [
      ...
      /* @__PURE__ */ jsx(NavLink, { to: "/projects", label: "Projects", onClick: () => setIsOpen(false) }),
      /* @__PURE__ */ jsx(NavLink, { to: "/experience", label: "Experience", onClick: () => setIsOpen(false) }),
      /* @__PURE__ */ jsx(NavLink, { to: "/contact", label: "Contact", onClick: () => setIsOpen(false) }),
...
function NavLink({
  ...
  return /* @__PURE__ */ jsx(Link, { to, activeOptions: {
    exact
  }, activeProps: {
    className: "text-blue-400 font-semibold"
  }, onClick, className: "hover:text-blue-300 transition text-white", children: label });
}
function SocialLink({
  href,
  icon
}) {
  return /* @__PURE__ */ jsx("a", { href, target: "_blank", rel: "noreferrer", className: "p-2 rounded-full hover:bg-blue-600/20 transition text-white", children: icon });
}
function GithubIcon() {
  return /* @__PURE__ */ jsx("svg", { viewBox: "0 0 24 24", fill: "currentColor", className: "w-6 h-6 text-white hover:text-blue-400 transition", children: /* @__PURE__ */ jsx("path", { d: "M12 .5C5.648.5.5 5.647.5 12c0 5.094 3.292 9.408 7.865 10.938.575.105.785-.25.785-.553 0-.272-.01-1.163-.016-2.108-3.198.695-3.875-1.54-3.875-1.54-.523-1.33-1.277-1.685-1.277-1.685-1.045-.715.08-.7.08-.7 1.156.082 1.764 1.188 1.764 1.188 1.027 1.758 2.695 1.25 3.352.957.104-.744.402-1.25.732-1.538-2.552-.29-5.237-1.277-5.237-5.68 0-1.255.449-2.283 1.186-3.09-.118-.29-.514-1.46.112-3.045 0 0 .964-.31 3.16 1.18a10.977 10.977 0 0 1 2.88-.388c.978.005 1.962.132 2.88.388 2.194-1.49 3.157-1.18 3.157-1.18.628 1.585.232 2.755.114 3.045.738.807 1.184 1.835 1.184 3.09 0 4.415-2.689 5.387-5.254 5.672.414.358.783 1.063.783 2.143 0 1.547-.014 2.792-.014 3.17 0 .307.207.665.792.552C20.71 21.405 24 17.09 24 12c0-6.353-5.147-11.5-12-11.5Z" }) });
}
function LinkedinIcon() {
  return /* @__PURE__ */ jsx("svg", { viewBox: "0 0 24 24", fill: "currentColor", className: "w-6 h-6 text-white hover:text-blue-400 transition", children: /* @__PURE__ */ jsx("path", { d: "M4.98 3.5C4.98 4.88 3.86 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1 4.98 2.12 4.98 3.5zM.5 8h4V24h-4V8zm7.5 0h3.8v2.2h.1c.53-1 1.83-2.2 3.77-2.2 4.03 0 4.78 2.65 4.78 6.1V24h-4v-7.6c0-1.8-.03-4.1-2.5-4.1-2.5 0-2.88 1.9-2.88 4V24h-4V8z" }) });
}
const $$splitComponentImporter$e = () => import("./users-BWn7rrrK.js");
...
const $$splitComponentImporter$d = () => import("./projects-C_acrBeF.js");
...
const $$splitComponentImporter$c = () => import("./experience-J3_jy08Z.js");
...
const $$splitComponentImporter$b = () => import("./deferred-yu5NIbLq.js");
...
const $$splitNotFoundComponentImporter$1 = () => import("./users._userId-DNUty1_t.js");
const $$splitComponentImporter$5 = () => import("./users._userId-Dhi50ROO.js");
...
const $$splitNotFoundComponentImporter = () => import("./posts._postId-DMFpBBCK.js");
const $$splitComponentImporter$4 = () => import("./posts._postId-fEdlvFuT.js");
...
const $$splitComponentImporter$2 = () => import("./posts_._postId.deep-BcsyToBP.js");
