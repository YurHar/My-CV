...
async function loadVirtualModule(id) {
  switch (id) {
    case VIRTUAL_MODULES.startManifest:
      return await import("./assets/_tanstack-start-manifest_v-DnThZHfc.js");
    case VIRTUAL_MODULES.serverFnManifest:
      return await import("./assets/_tanstack-start-server-fn-manifest_v-cEoyEXwU.js");
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./assets/router-DgKkjbIf.js").then((n) => n.r);
    }
    if (startEntry === null) {
