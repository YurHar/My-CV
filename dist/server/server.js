...
async function loadVirtualModule(id) {
  switch (id) {
    case VIRTUAL_MODULES.startManifest:
      return await import("./assets/_tanstack-start-manifest_v-BBLwdSzc.js");
    case VIRTUAL_MODULES.serverFnManifest:
      return await import("./assets/_tanstack-start-server-fn-manifest_v-D_XOcSnI.js");
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./assets/router-BFMlp6O8.js").then((n) => n.r);
    }
    if (startEntry === null) {
